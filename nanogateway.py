...
class NanoGateway:
    ...
    def start(self):
        ...
        #while not self.rtc.synced():# Whith Internet Access
                    #utime.sleep_ms(50)# Whith Internet Access
        self.rtc.synced() # without Internet Access
        #self.rtc.init((2019,4,1,18,20,0,0,0))# without Internet Access without
